    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#tt").jqGrid({
                ...
                url: "${pageContext.servletContext.contextPath}/teacher/getAll",//获取服务端数据url 注意获取结果要json
                datatype: "json",//预期服务器返回结果类型
                mtype: "post",//请求方式
                colNames: ["ID", "用户名", "昵称", "头像"],//列名称数组
                colModel: [
                ...
                editurl: "${pageContext.servletContext.contextPath}/teacher/edit",//开启编辑时执行编辑操作的url路径  添加  修改  删除
